...
},{"./modules/scroll2Top.js":2,"./modules/shareKit.js":3,"./modules/transitionend.js":4}],2:[function(require,module,exports){
;(function(){
    ...
    var wechatFunc = function(e){
        ...
        if(e != null) {
            ...
            wechatShare = {
                ...
                'desc': conf.desc,
                'title': conf.title,
                'img': 'http://usualimages.qiniudn.com/1.jpeg'
            };
            wechatTool('friend', wechatShare);
            wechatTool('timeline', wechatShare);
        }
    };
